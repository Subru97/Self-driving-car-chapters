...
# lane_marked_image = cv2.addWeighted(lane_image, 0.8, lines_image, 1, 1)
# cv2.imshow('result', lane_marked_image)
# plt.imshow(canny)
...
while(video_capture.isOpened()):
    ...
    lane_marked_image = cv2.addWeighted(frame, 0.8, lines_image, 1, 1)
    cv2.imshow('result', lane_marked_image)
    cv2.waitKey(1)
